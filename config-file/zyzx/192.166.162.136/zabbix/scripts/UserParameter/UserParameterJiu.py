...
if __name__ == "__main__":
    ...
    mea_query("http://192.166.162.134/monitor/v1/timeline/metrics?metricNames=serviceCalllog&hostName=a&appId=b&startTime=1541651940&endTime=1541652000&precision=10",sys_name,datatype)
